...
Train_set={}
Train_set['chest+wrist_segementation_baseline'] = x_baseline
Train_set['chest+wrist_segementation_amusement'] = x_amusement
Train_set['chest+wrist_segementation_stress'] = x_stress
...
Test_set={}
Test_set['chest+wrist_segementation_baseline_test'] = y_baseline
Test_set['chest+wrist_segementation_amusement_test'] = y_amusement
Test_set['chest+wrist_segementation_stress_test'] = y_stress


with open("../data/train.pkl", "wb") as fp:
    pickle.dump(Train_set, fp, protocol = pickle.HIGHEST_PROTOCOL)

with open("../data/test.pkl", "wb") as fp:
    pickle.dump(Test_set, fp, protocol = pickle.HIGHEST_PROTOCOL)
